...
static const char * const dirtylooks_arrow_down_xpm[] = {
    "11 7 2 1",
    " 	c None",
    "x	c #000000",
    "           ",
...
static const char * const dirtylooks_arrow_up_xpm[] = {
    "11 7 2 1",
    " 	c None",
    "x	c #000000",
    "     x     ",
...
static const char * const dirtylooks_radiobutton[] = {
    "13 13 9 1",
    " 	c None",
    ".	c #ABA094",
    "+	c #B7ADA0",
...
static const char * const dirtylooks_radiobutton_checked[] = {
    "13 13 20 1",
    " 	c None",
    ".	c #A8ABAE",
    "+	c #596066",
...
static const char * const dirtylooks_menuitem_checkbox_checked[] = {
    "8 7 6 1",
    " 	g None",
    ".	g #959595",
    "+	g #676767",
...
static const char * const dirtylooks_checkbox_checked[] = {
    "13 13 3 1",
    " 	c None",
    ".	c #272D33",
    "%	c #666666",
...
static void dirtylooks_draw_gradient(QPainter *painter, const QRect &rect, const QColor &gradientStart,
...
static void dirtylooks_draw_buttongradient(QPainter *painter, const QRect &rect, const QColor &gradientStart,
...
static void dirtylooks_draw_mdibutton(QPainter *painter, const QStyleOptionTitleBar *option, const QRect &tmp, bool hover, bool sunken)
{
    QColor dark;
...
/*!
    \class DirtylooksStyle
    \brief The DirtylooksStyle class provides a widget style similar to the
...
/*!
    Destroys the DirtylooksStyle object.
*/
DirtylooksStyle::~DirtylooksStyle()
{
}

/*!
    \fn void DirtylooksStyle::drawItemText(QPainter *painter, const QRect &rectangle, int alignment, const QPalette &palette,
    ...
    \sa Qt::Alignment
*/
void DirtylooksStyle::drawItemText(QPainter *painter, const QRect &rect, int alignment, const QPalette &pal,
                                    bool enabled, const QString& text, QPalette::ColorRole textRole) const
{
    if (text.isEmpty())
        return;
...
/*!
    \reimp
*/
void DirtylooksStyle::drawPrimitive(PrimitiveElement elem,
                        ...
                        QPainter *painter, const QWidget *widget) const
{
    ...
    case PE_IndicatorHeaderArrow:
        if (const QStyleOptionHeader *header = qstyleoption_cast<const QStyleOptionHeader *>(option)) {
            ...
            if (header->sortIndicator & QStyleOptionHeader::SortUp)
                arrow = QImage(dirtylooks_arrow_up_xpm);
            else if (header->sortIndicator & QStyleOptionHeader::SortDown)
                arrow = QImage(dirtylooks_arrow_down_xpm);
            if (!arrow.isNull()) {
    ...
    case PE_IndicatorCheckBox:
        ...
        if (const QStyleOptionButton *checkbox = qstyleoption_cast<const QStyleOptionButton*>(option)) {
            ...
            if (checkbox->state & (State_On | State_Sunken  | State_NoChange)) {
                QImage image(dirtylooks_checkbox_checked);
    ...
    case PE_IndicatorRadioButton:
        painter->save();
        {
            ...
            if (state & (State_On )) {
                painter->drawImage(rect, QImage(dirtylooks_radiobutton));
                painter->drawImage(checkRect, QImage(dirtylooks_radiobutton_checked));
            }
    ...
    case PE_PanelButtonCommand:
        {
            ...
            if (isDown) {
                ...
                if (isEnabled && option->state & State_MouseOver ) {
                    dirtylooks_draw_buttongradient(p, gradRect,
...
/*!
  \reimp
*/
void DirtylooksStyle::drawControl(ControlElement element, const QStyleOption *option, QPainter *painter,
                                   const QWidget *widget) const
{
    ...
    case CE_MenuBarItem:
        ...
        if (const QStyleOptionMenuItem *mbi = qstyleoption_cast<const QStyleOptionMenuItem *>(option))
        {
            ...
            QRect r = option->rect;
            if (act) {
                dirtylooks_draw_gradient(painter, r.adjusted(1, 1, -1, -1),
                                            highlight,
    ...
    case CE_MenuItem:
        ...
        if (const QStyleOptionMenuItem *menuItem = qstyleoption_cast<const QStyleOptionMenuItem *>(option)) {
            ...
            if (selected) {
                ...
                dirtylooks_draw_gradient(painter, r, highlight,
                                            highlightOutline, TopDown,
                                            highlight);
                ...
                if (checkable) {
                    if (menuItem->checkType & QStyleOptionMenuItem::Exclusive) {
                        ...
                        if (menuItem->icon.isNull()) {
                            if (checked || sunken) {
                                QImage image(dirtylooks_menuitem_checkbox_checked);
...
/*!
  \reimp
*/
void DirtylooksStyle::drawComplexControl(ComplexControl control, const QStyleOptionComplex *option,
                                         QPainter *painter, const QWidget *widget) const
{
    QColor button = option->palette.button().color();
    QColor dark;
        ...
        if (const QStyleOptionSpinBox *spinBox = qstyleoption_cast<const QStyleOptionSpinBox *>(option)) {
            ...
            if (!QPixmapCache::find(pixmapName, &cache)) {
                ...
                if (spinBox->frame) {
                    ...
                    // gradients
                    dirtylooks_draw_gradient(&cachePainter, upRect,
                                            gradientStartColor.darker(106),
                                            gradientStopColor, TopDown, option->palette.button());
                    dirtylooks_draw_gradient(&cachePainter, downRect.adjusted(0, 0, 0, 1),
                                            gradientStartColor.darker(106),
                                            gradientStopColor, TopDown, option->palette.button());
                if (isEnabled) {
                    if (upIsActive) {
                        if (sunken) {
                            ...
                            dirtylooks_draw_gradient(&cachePainter, upRect.adjusted(1, 0, 0, 0),
                    ...
                    if (downIsActive) {
                        if (sunken) {
                            cachePainter.fillRect(downRect.adjusted(1, 0, 0, 1), gradientStopColor.darker(110));
                                ...
                                dirtylooks_draw_gradient(&cachePainter, downRect.adjusted(1, 0, 0, 1),
                                                        gradientStartColor.lighter(110),
                                                        gradientStopColor.lighter(110), TopDown, option->palette.button());
                        }
                    }
        ...
        if (const QStyleOptionTitleBar *titleBar = qstyleoption_cast<const QStyleOptionTitleBar *>(option)) {
            ...
            if ((titleBar->subControls & SC_TitleBarMinButton) && (titleBar->titleBarFlags & Qt::WindowMinimizeButtonHint) &&
                ...
                if (minButtonRect.isValid()) {
                    ...
                    dirtylooks_draw_mdibutton(painter, titleBar, minButtonRect, hover, sunken);
            ...
            if ((titleBar->subControls & SC_TitleBarMaxButton) && (titleBar->titleBarFlags & Qt::WindowMaximizeButtonHint) &&
                ...
                if (maxButtonRect.isValid()) {
                    ...
                    dirtylooks_draw_mdibutton(painter, titleBar, maxButtonRect, hover, sunken);
            ...
            if ((titleBar->subControls & SC_TitleBarCloseButton) && (titleBar->titleBarFlags & Qt::WindowSystemMenuHint)) {
                ...
                if (closeButtonRect.isValid()) {
                    ...
                    dirtylooks_draw_mdibutton(painter, titleBar, closeButtonRect, hover, sunken);
            ...
            if ((titleBar->subControls & SC_TitleBarNormalButton) &&
               ...
               (titleBar->titleBarState & Qt::WindowMaximized)))) {
                ...
                if (normalButtonRect.isValid()) {
                    ...
                    dirtylooks_draw_mdibutton(painter, titleBar, normalButtonRect, hover, sunken);
            ...
            if (titleBar->subControls & SC_TitleBarContextHelpButton
                ...
                if (contextHelpButtonRect.isValid()) {
                    ...
                    dirtylooks_draw_mdibutton(painter, titleBar, contextHelpButtonRect, hover, sunken);
            ...
            if (titleBar->subControls & SC_TitleBarShadeButton && (titleBar->titleBarFlags & Qt::WindowShadeButtonHint)) {
                ...
                if (shadeButtonRect.isValid()) {
                    ...
                    dirtylooks_draw_mdibutton(painter, titleBar, shadeButtonRect, hover, sunken);
            ...
            if (titleBar->subControls & SC_TitleBarUnshadeButton && (titleBar->titleBarFlags & Qt::WindowShadeButtonHint)) {
                ...
                if (unshadeButtonRect.isValid()) {
                    ...
                    dirtylooks_draw_mdibutton(painter, titleBar, unshadeButtonRect, hover, sunken);
            ...
            if (scrollBar->subControls & SC_ScrollBarSubLine) {
                ...
                if (isEnabled ) {
                    ...
                    if ((scrollBar->activeSubControls & SC_ScrollBarSubLine) && sunken) {
                        dirtylooks_draw_gradient(painter,
                                                    QRect(fillRect),
        ...
        if (const QStyleOptionComboBox *comboBox = qstyleoption_cast<const QStyleOptionComboBox *>(option)) {
            ...
            if (!QPixmapCache::find(pixmapName, &cache)) {
                ...
                if (comboBox->subControls & SC_ComboBoxArrow) {
                    if (comboBox->editable) {
                        // Draw the down arrow
                        QImage downArrow(dirtylooks_arrow_down_xpm);
        ...
        if (const QStyleOptionSlider *slider = qstyleoption_cast<const QStyleOptionSlider *>(option)) {
            ...
            if ((option->subControls & SC_SliderHandle) ) {
                ...
                if (!QPixmapCache::find(handlePixmapName, &cache)) {
                    ...
                    dirtylooks_draw_gradient(&handlePainter, gradRect,
                    ...
                    dirtylooks_draw_gradient(&handlePainter, horizontal ?
...
/*!
  \reimp
*/
int DirtylooksStyle::pixelMetric(PixelMetric metric, const QStyleOption *option, const QWidget *widget) const
{
    int ret = -1;
    switch (metric) {
...
/*!
  \reimp
*/
QSize DirtylooksStyle::sizeFromContents(ContentsType type, const QStyleOption *option,
...
/*!
  \reimp
*/
void DirtylooksStyle::polish(QApplication *app)
{
...
/*!
  \reimp
*/
void DirtylooksStyle::polish(QWidget *widget)
{
...
/*!
  \reimp
*/
void DirtylooksStyle::unpolish(QWidget *widget)
{
...
/*!
  \reimp
*/
void DirtylooksStyle::unpolish(QApplication *app)
{
...
/*!
  \reimp
*/
bool DirtylooksStyle::event(QEvent *event)
{
    switch (event->type()) {
    case QEvent::Timer: {
#ifndef QT_NO_PROGRESSBAR
...
/*!
  \reimp
*/
bool DirtylooksStyle::eventFilter(QObject *o, QEvent *e)
{
    switch (e->type())
    {
#ifndef QT_NO_PROGRESSBAR
...
void DirtylooksStyle::startProgressAnimation(QObject *o, QProgressBar *bar)
{
...
void DirtylooksStyle::stopProgressAnimation(QObject *o, QProgressBar *bar)
{
...
/*!
  \reimp
*/
QRect DirtylooksStyle::subControlRect(ComplexControl control, const QStyleOptionComplex *option,
...
/*!
  \reimp
*/
QRect DirtylooksStyle::itemPixmapRect(const QRect &r, int flags, const QPixmap &pixmap) const
{
...
/*!
  \reimp
*/
void DirtylooksStyle::drawItemPixmap(QPainter *painter, const QRect &rect,
...
/*!
  \reimp
*/
QStyle::SubControl DirtylooksStyle::hitTestComplexControl(ComplexControl cc, const QStyleOptionComplex *opt,
...
/*!
  \reimp
*/
QPixmap DirtylooksStyle::generatedIconPixmap(QIcon::Mode iconMode, const QPixmap &pixmap,
...
/*!
  \reimp
*/
int DirtylooksStyle::styleHint(StyleHint hint, const QStyleOption *option, const QWidget *widget,
...
/*! \reimp */
QRect DirtylooksStyle::subElementRect(SubElement sr, const QStyleOption *opt, const QWidget *w) const
{
...
/*!
    \reimp
*/
QIcon DirtylooksStyle::standardIcon(StandardPixmap standardIcon, const QStyleOption *option,
                                     const QWidget *widget) const
{
...
/*!
 \reimp
 */
QPixmap DirtylooksStyle::standardPixmap(StandardPixmap standardPixmap, const QStyleOption *opt,
                                      const QWidget *widget) const
{
    QPixmap pixmap;
