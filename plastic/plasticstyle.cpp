...
static void qBrushSetAlphaF(QBrush *brush, qreal alpha)
{
    if (const QGradient *gradient = brush->gradient()) {
        ...
        default:
            qWarning("PlasticStyle::qBrushLight() - unknown gradient type"
...
static QBrush qBrushDark(QBrush brush, int dark)
{
    if (const QGradient *gradient = brush.gradient()) {
        ...
        default:
            qWarning("PlasticStyle::qBrushDark() - unknown gradient type"
                     " - falling back to QLinearGradient");
            Q_FALLTHROUGH();
        case QGradient::LinearGradient: {
            QLinearGradient grad = *static_cast<const QLinearGradient *>(gradient);
...
/*!
    \class PlasticStyle
    \brief The PlasticStyle class provides a widget style similar to the
...
/*!
    Destructs the PlasticStyle object.
*/
PlasticStyle::~PlasticStyle()
{
}
...
/*!
  \reimp
*/
void PlasticStyle::drawPrimitive(PrimitiveElement element, const QStyleOption *option,
...
/*!
  \reimp
*/
void PlasticStyle::drawControl(ControlElement element, const QStyleOption *option,
                                  QPainter *painter, const QWidget *widget) const
{
    QColor borderColor = option->palette.window().color().darker(178);
    QColor alphaCornerColor;
...
/*!
  \reimp
*/
void PlasticStyle::drawComplexControl(ComplexControl control, const QStyleOptionComplex *option,
                                         QPainter *painter, const QWidget *widget) const
{
    QColor borderColor = option->palette.window().color().darker(178);
    QColor alphaCornerColor;
...
/*!
  \reimp
*/
QSize PlasticStyle::sizeFromContents(ContentsType type, const QStyleOption *option,
...
/*!
  \reimp
*/
QRect PlasticStyle::subElementRect(SubElement element, const QStyleOption *option, const QWidget *widget) const
{
    QRect rect;
    switch (element) {
...
/*!
  \reimp
*/
QRect PlasticStyle::subControlRect(ComplexControl control, const QStyleOptionComplex *option,
...
/*!
  \reimp
*/
int PlasticStyle::styleHint(StyleHint hint, const QStyleOption *option, const QWidget *widget,
...
/*!
  \reimp
*/
QStyle::SubControl PlasticStyle::hitTestComplexControl(ComplexControl control, const QStyleOptionComplex *option,
...
/*!
  \reimp
*/
int PlasticStyle::pixelMetric(PixelMetric metric, const QStyleOption *option, const QWidget *widget) const
{
    int ret = -1;
    switch (metric) {
    case PM_MenuVMargin:
...
/*!
  \reimp
*/
QPalette PlasticStyle::standardPalette() const
{
    QPalette palette;
...
/*!
  \reimp
*/
void PlasticStyle::polish(QWidget *widget)
{
...
/*!
  \reimp
*/
void PlasticStyle::unpolish(QWidget *widget)
{
    if (qobject_cast<QPushButton *>(widget)
#ifndef QT_NO_COMBOBOX
        || qobject_cast<QComboBox *>(widget)
...
/*!
  \reimp
*/
void PlasticStyle::polish(QApplication *app)
{
...
/*!
  \reimp
*/
void PlasticStyle::unpolish(QApplication *app)
{
...
/*!
    \reimp
*/
QIcon PlasticStyle::standardIcon(StandardPixmap standardIcon, const QStyleOption *option,
...
/*!
    \reimp
*/
QPixmap PlasticStyle::standardPixmap(StandardPixmap standardPixmap, const QStyleOption *opt,
                                        const QWidget *widget) const
{
...
/*!
    \reimp
*/
int PlasticStyle::layoutSpacing(QSizePolicy::ControlType control1,
...
/*!
    \reimp
*/
bool PlasticStyle::event(QEvent *event)
{
    switch (event->type()) {
    case QEvent::Timer: {
#ifndef QT_NO_PROGRESSBAR
...
void PlasticStyle::startProgressAnimation(QProgressBar *bar)
{
...
void PlasticStyle::stopProgressAnimation(QProgressBar *bar)
{
    if (!bars.isEmpty()) {
        bars.removeOne(bar);
