...
*/
bool OldschoolStyle::eventFilter(QObject *o, QEvent *e)
{
...
void OldschoolStyle::startProgressAnimation(QProgressBar *bar)
{
...
void OldschoolStyle::stopProgressAnimation(QProgressBar *bar)
{
    if (!bars.isEmpty()) {
        bars.removeOne(bar);
...
/*!
    \reimp
*/
QIcon OldschoolStyle::standardIcon(StandardPixmap standardIcon, const QStyleOption *opt,
...
/*!
    \reimp
*/
void OldschoolStyle::timerEvent(QTimerEvent *event)
{
#ifndef QT_NO_PROGRESSBAR
...
/*!
  ...
  \sa QStyle::polish()
*/
void OldschoolStyle::setUseHighlightColors(bool arg)
{
    highlightCols = arg;
}
...
/*!
  ...
  default is false.
*/
bool OldschoolStyle::useHighlightColors() const
{
...
*/
void OldschoolStyle::polish(QWidget* widget)
{
...
/*!
  ...
  Keep QStyle::polish() visible.
*/
void OldschoolStyle::unpolish(QWidget* widget)
{
...
/*!
  ...
  Keep QStyle::polish() visible.
*/
void OldschoolStyle::polish(QApplication* a)
{
...
/*!
  ...
  Keep QStyle::polish() visible.
*/
void OldschoolStyle::unpolish(QApplication* a)
{
...
/*!
  \reimp
*/
void OldschoolStyle::drawPrimitive(PrimitiveElement pe, const QStyleOption *opt, QPainter *p,
...
/*!
  \reimp
*/
void OldschoolStyle::drawControl(ControlElement element, const QStyleOption *opt, QPainter *p,
                              const QWidget *widget) const
{
    switch (element) {
    case CE_Splitter: {
...
/*!
  \reimp
*/
void OldschoolStyle::drawComplexControl(ComplexControl cc, const QStyleOptionComplex *opt, QPainter *p,
                                     const QWidget *widget) const
{
    switch (cc) {
    case CC_ToolButton:
...
/*! \reimp */
int OldschoolStyle::pixelMetric(PixelMetric pm, const QStyleOption *opt,
                             const QWidget *widget) const
{
    int ret = 0;
...
*/
QRect
OldschoolStyle::subControlRect(ComplexControl cc, const QStyleOptionComplex *opt,
...
*/
QSize
OldschoolStyle::sizeFromContents(ContentsType ct, const QStyleOption *opt,
...
*/
QRect
OldschoolStyle::subElementRect(SubElement sr, const QStyleOption *opt, const QWidget *widget) const
{
    QRect rect;
...
*/
QPixmap
OldschoolStyle::standardPixmap(StandardPixmap standardPixmap, const QStyleOption *opt,
                            const QWidget *widget) const
{
#ifndef QT_NO_IMAGEFORMAT_XPM
...
/*! \reimp */
bool OldschoolStyle::event(QEvent *e)
{
...
/*! \reimp */
int
OldschoolStyle::styleHint(StyleHint hint, const QStyleOption *opt, const QWidget *widget,
...
/*! \reimp */
QPalette OldschoolStyle::standardPalette() const
{
